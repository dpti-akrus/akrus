    ...
    return (
        <main>
            ...
            <section className="biblioteca-virtual">
                <h2 className="biblioteca-title"><span>Biblioteca Virtual</span></h2>
                <p className="biblioteca-description">
                    ...
                    estamos comprometidos em oferecer recursos de leitura de qualidade para
                    todos os membros da nossa comunidade. Queremos que você se sinta
            ...
            <section className="podcasts-section">
                <h2 className="podcasts-title"><span>Podcast</span></h2>
            ...
            <div className="book-card" id="bookCard">
                {/* <span className="close" onClick="fecharCard()">&times;</span> */}
                ...
                <div className="book-info">
                    ...
                    <a id="bookLink" href="#" target="_blank">Comprar</a>
                </div>
            </div>
